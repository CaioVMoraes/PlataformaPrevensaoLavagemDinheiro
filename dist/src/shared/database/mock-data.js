...
exports.mockedAuditLogs = exports.mockedInvestigations = exports.mockedAlerts = void 0;
const alert_status_1 = require("../domain/alert-status");
const analyst_role_1 = require("../domain/analyst-role");
const audit_event_type_1 = require("../domain/audit-event-type");
const investigation_status_1 = require("../domain/investigation-status");
const risk_classification_1 = require("../domain/risk-classification");
exports.mockedAlerts = [
    {
        id: 'ALT-1001',
        status: alert_status_1.AlertStatus.IN_ANALYSIS,
        riskClassification: risk_classification_1.RiskClassification.HIGH,
    ...
    {
        id: 'ALT-1002',
        status: alert_status_1.AlertStatus.PENDING,
        riskClassification: risk_classification_1.RiskClassification.CRITICAL,
...
exports.mockedInvestigations = [
    {
        id: 'INV-5001',
        alertId: 'ALT-1001',
        status: investigation_status_1.InvestigationStatus.UNDER_REVIEW,
        assignedTo: 'Camila Rocha',
        assignedRole: analyst_role_1.AnalystRole.PLD_ANALYST,
        openedAt: '2026-06-10T14:00:00.000Z',
        closedAt: null,
        suggestedRisk: risk_classification_1.RiskClassification.HIGH,
        evidences: [
            {
                id: 'EVD-7001',
    ...
    },
    {
        id: 'INV-5002',
        alertId: 'ALT-1002',
        status: investigation_status_1.InvestigationStatus.OPEN,
        assignedTo: 'Bruno Martins',
        assignedRole: analyst_role_1.AnalystRole.PLD_COORDINATOR,
        openedAt: '2026-06-11T09:45:00.000Z',
        closedAt: null,
        suggestedRisk: risk_classification_1.RiskClassification.CRITICAL,
        evidences: [
            {
                id: 'EVD-7101',
...
exports.mockedAuditLogs = [
    {
        id: 'AUD-3001',
        user: 'system',
        action: audit_event_type_1.AuditEventType.ALERT_CREATED,
        resource: 'ALT-1001',
        result: 'SUCCESS',
    ...
    },
    {
        id: 'AUD-3002',
        user: 'Camila Rocha',
        action: audit_event_type_1.AuditEventType.CUSTOMER_QUERY,
        resource: 'CUS-001',
        result: 'SUCCESS',
